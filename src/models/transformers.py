...
class _TransformerHead(nn.Module):
    def __init__(self, in_dim, d_model=128, nhead=4, num_layers=2, dim_feedforward=256,
    ...
    def forward(self, x):  # x: (B, L, F)
        ...
        h_last = x[:, -1, :]  # (B, d_model) - take last timestep
...
class TransformerRegressor:
    """
    Transformer model with left-padded sliding windows.
